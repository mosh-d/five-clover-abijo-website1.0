          ...
          <li>
            ...
            <ul className="list-disc pl-[3rem] mt-[1.5rem] flex flex-col gap-[1.5rem]">
              ...
              <li>
                ...
                links to third-party websites. Five Clover Hotel Abijo is not
          ...
          <li>
            ...
            <ul className="list-disc pl-[3rem] mt-[1.5rem] flex flex-col gap-[1.5rem]">
              <li>
                ...
                of Five Clover Hotel Abijo or its licensors and is protected by
          ...
          <li>
            ...
            <ul className="list-disc pl-[3rem] mt-[1.5rem] flex flex-col gap-[1.5rem]">
              <li>
                ...
                your own risk. Five Clover Hotel Abijo does not warrant that the
                website will be error-free or that access will be
                uninterrupted. The information provided is on an "as-is"
                basis.
              </li>
              <li>
                <strong>Limitation of Liability:</strong> Five Clover Hotel Abijo shall
